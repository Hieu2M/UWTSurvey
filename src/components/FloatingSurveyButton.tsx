...
export default function FloatingSurveyButton() {
    ...
    return (
        ...
        `}
            >
                <p className="text-gray-700 whitespace-nowrap">Short Survey</p>
            </div>
            ...
            >
               {/*<MessageCircle className="h-6 w-6 transform transition-transform group-hover:rotate-12 items-center" />*/}
